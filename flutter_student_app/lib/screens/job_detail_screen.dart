  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loading
          ...
          : _job == null
              ? const Center(child: Text('Job not found', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)))
              : Stack(
                  children: [
                    // Main Content
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                // Company Logo Avatar
                                _buildCompanyLogo(_job!['job_company_id']?['company_name'], _job!['job_company_id']?['company_logo']),
                                ...
                                // Company Name
                                Text(
                                  _job!['job_company_id']?['company_name'] ?? 'Company Name',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    _buildHeaderChip(_job!['job_type'] ?? 'Full-time', const Color(0xFF3B82F6)),
                                    _buildHeaderChip(_job!['job_work_mode'] ?? 'In Office', const Color(0xFF10B981)),
                                  ],
                                ),
                              ],
                            ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _job!['job_desc'] ?? 'No description provided.',
                                      style: const TextStyle(
                                    ...
                                    Wrap(
                                      spacing: 8,
                                      runSpacing: 8,
                                      children: _parseSkills(_job!['job_skills']).map((skill) {
                                        return Container(
                          ...
                          if (_job!['rounds'] != null && (_job!['rounds'] as List).isNotEmpty)
                            Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ...List.generate((_job!['rounds'] as List).length, (index) {
                                        final round = (_job!['rounds'] as List)[index];
                                        return Row(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            // Timeline dot & line
                                            Column(
                                              children: [
                                                ...
                                                if (index < (_job!['rounds'] as List).length - 1)
                                                  Container(
                                                    width: 2,
                                                    height: 48,
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  if (round['round_description'] != null &&
                                                      round['round_description'].toString().trim().isNotEmpty) ...[
