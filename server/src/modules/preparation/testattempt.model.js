...
const AnswerSchema = new mongoose.Schema({
  question_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_prep_question", required: true },
  selected_option: { type: Number, default: -1 },
  is_correct: { type: Boolean, default: false },
  is_skipped: { type: Boolean, default: true },
  time_spent_seconds: { type: Number, default: 0 },
}, { _id: false });

const TestAttemptSchema = new mongoose.Schema(
  {
    student_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_student", required: true },
    test_type: {
      type: String,
      enum: ["mock_test", "practice", "daily_challenge", "previous_year"],
      required: true,
    },
    mock_test_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_prep_mocktest", default: null },
