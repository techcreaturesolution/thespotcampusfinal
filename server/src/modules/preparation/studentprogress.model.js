...
const SubjectProgressSchema = new mongoose.Schema({
  subject_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_prep_subject" },
...
const TopicProgressSchema = new mongoose.Schema({
  topic_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_prep_topic" },
...
const StudentProgressSchema = new mongoose.Schema(
  {
    student_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_student", required: true, unique: true },
    total_questions_solved: { type: Number, default: 0 },
    total_correct: { type: Number, default: 0 },
    tests_attempted: { type: Number, default: 0 },
    overall_accuracy: { type: Number, default: 0 },
    current_streak: { type: Number, default: 0 },
    longest_streak: { type: Number, default: 0 },
    last_active_date: { type: String, default: "" },
    daily_challenge_streak: { type: Number, default: 0 },
    daily_challenges_completed: { type: Number, default: 0 },
    subject_progress: [SubjectProgressSchema],
    topic_progress: [TopicProgressSchema],
    weekly_activity: [
      {
        date: { type: String },
    ...
    reading_progress: [
      {
        pdf_id: { type: mongoose.Schema.Types.ObjectId, ref: "tbl_prep_pdfmaterial" },
...
StudentProgressSchema.index({ student_id: 1 }, { unique: true });
