    ...
    <div className="min-h-screen bg-[#f8f9ff] text-[#0b1c30] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden selection:bg-[#3730a3] selection:text-white">
      ...
      <div className="max-w-lg w-full glass-panel rounded-[2rem] p-8 md:p-10 shadow-2xl shadow-indigo-950/5 relative border border-white/60 glow-soft mt-12 mb-8 bg-white/80 backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">Affiliated University</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="college_name" className="w-full px-4 py-3 bg-[#f8f9ff]/70 border border-slate-200 focus:border-[#3730a3] focus:bg-white outline-none rounded-xl text-sm transition-all duration-200 pl-10 pr-4 focus:ring-4 focus:ring-indigo-500/5" value={formData.college_name} onChange={handleChange} required />
              </div>
            </div>

            {/* College Code */}
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">College Code</label>
              <div className="relative">
                <FiShield className="absolute left-3.5 top-3.5 text-[#3730a3] w-4.5 h-4.5" />
                <input type="text" name="college_code" className="w-full px-4 py-3 bg-[#f8f9ff]/70 border border-slate-200 focus:border-[#3730a3] focus:bg-white outline-none rounded-xl text-sm transition-all duration-200 pl-10 pr-4 focus:ring-4 focus:ring-indigo-500/5" value={formData.college_code} onChange={handleChange} required />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea name="college_address" rows="2" className="w-full px-4 py-3 bg-[#f8f9ff]/70 border border-slate-200 focus:border-[#3730a3] focus:bg-white outline-none rounded-xl text-sm transition-all duration-200 pl-10 pr-4 focus:ring-4 focus:ring-indigo-500/5 resize-none" value={formData.college_address} onChange={handleChange} required />
            </div>
          </div>
