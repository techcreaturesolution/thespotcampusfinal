  ...
  return (
    <main className="min-h-screen bg-[#f8f9ff] text-[#0b1c30] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden selection:bg-[#3730a3] selection:text-white">
      <SEO 
        ...
        description="Register your university on The Spot Campus. Oversee affiliated colleges, run combined placement drives, and coordinate standard examinations."
        keywords="university register, university sign up, campus placement board"
        canonical="https://thespotcampus.com/sign-up-university"
      />
