...
import { FiTrash2, FiUsers, FiUserCheck, FiUserX } from "react-icons/fi";
  ...
  return (
    <div className="max-w-7xl mx-auto px-1 sm:px-4 py-3">
      <PageHeader
        ...
        badge={`${students.length} candidates`}
      />
      <DataTable
        data={students}
        searchKeys={["student_name", "student_email", "college_id.college_name", "branch_id.branch_name"]}
        searchPlaceholder="Search candidates by name, email, college or branch..."
            ...
            render: (s) => (
              <div className="flex items-center gap-3 py-1">
                ...
                <div className="text-left">
                  ...
                  <span className="text-[10px] font-semibold text-slate-400 mt-0.5">{s.student_email}</span>
                </div>
              </div>
            ),
          },
              ...
              <div className="flex items-center justify-end gap-1.5">
                {role === "TPO" && (
                  <IconButton
                    ...
                    title={s.isVerifiedByTPO ? "Unverify Candidate" : "Verify Candidate"}
                ...
                <IconButton variant="danger" title="Delete Candidate Record" onClick={() => handleDelete(s._id)}>
