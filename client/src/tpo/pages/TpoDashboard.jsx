  ...
  return (
    <div className="space-y-8">
      <Hero
        ...
        subtitle="Bridge recruiters and students — manage candidates and track placement openings."
        statusText="Coordination active"
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col justify-center p-8 bg-gradient-to-br from-primary-50 via-white to-indigo-50/30">
          ...
          <h3 className="text-lg font-bold text-gray-900">TPO Coordination</h3>
          <p className="text-gray-500 text-sm mt-1.5 leading-relaxed">
            Connect corporate recruiters with your college, guide students through applications, and support qualification matching.
          </p>
        </div>
      </div>
    </div>
