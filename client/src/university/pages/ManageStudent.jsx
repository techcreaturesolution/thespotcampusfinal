...
import { FiTrash2, FiUsers, FiMail, FiBookOpen } from "react-icons/fi";
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            render: (s) => (
              <div className="flex flex-col text-xs font-semibold text-slate-500 max-w-[250px] truncate" title={s.college_id?.college_name}>
